    ...
    return (
      <div className={styles.main}>
        <Form onSubmit={this.handleSubmit} className="login-form">
          ...
          <FormItem>
            <span className="pull-right color-primary pointer" onClick={()=>{dispatch(routerRedux.push("/user/login"))}}>
              已有账号？登录
            </span>
            <Button type="primary" htmlType="submit" size="large" className="wp100">
              注册
          </Button>
          </FormItem>
        </Form>
